...
- `sw.js` -- Service Worker (Cache-Name: greif-V40.1 -- synchron mit HTML)
...
- V40.1 Usability: Resume-Banner (Zuletzt gelesen), Notfall-Button (⚡ Schnellentscheider), Kapitel-Link kopieren, Allergien & Unverträglichkeiten in Lagerung
