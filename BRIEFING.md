...
- `sw.js` -- Service Worker (Cache-Name: greif-V44.2 -- synchron mit HTML)
...
- `preview.png` -- 1200x630 OG-Bild, bei Kapitelzahl- oder Versionsänderung regenerieren (PIL-Skript, "94 Kapitel · V44.2")
...
- **ng-l3c2 (Katastrophen, Personen & Recht):** naturgefahren, hitzewelle, abc-schutz, epidemiologie-krise, pandemie-biobedrohung, krieg-unruhen, familiennotfallplan, alleinstehende-krise, behinderung-krise, senioren-krise (NEU V44.2), haustier-krise (NEU V42.9), recovery-nachkrise (NEU V42.9), recht-krisenfall
