...
- `sw.js` -- Service Worker (Cache-Name: greif-V40.6 -- synchron mit HTML)
...
- V40.6 Usability: Resume-Banner (Zuletzt gelesen), Notfall-Button (⚡ Schnellentscheider), Kapitel-Link kopieren, Allergien & Unverträglichkeiten in Lagerung
