...
## Aktueller Stand
**Version: V43.5** (Juli 2026)
92 Kapitel | 1,72 MB | 7 JS-Blöcke | 118.000 Wörter
...
- `sw.js` -- Service Worker (Cache-Name: greif-V43.5 -- synchron mit HTML)
...
- V43.5 Usability: Resume-Banner (Zuletzt gelesen), Notfall-Button (⚡ Schnellentscheider), Kapitel-Link kopieren, Allergien & Unverträglichkeiten in Lagerung
...
- Alle 92 Kapitel auf Stand Juli 2026
