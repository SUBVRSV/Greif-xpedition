...
- `sw.js` -- Service Worker (Cache-Name: greif-V41.2 -- synchron mit HTML)
...
- V41.2 Usability: Resume-Banner (Zuletzt gelesen), Notfall-Button (⚡ Schnellentscheider), Kapitel-Link kopieren, Allergien & Unverträglichkeiten in Lagerung
